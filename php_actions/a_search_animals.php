...
$sql = "SELECT *, TIMESTAMPDIFF(YEAR, date_of_birth, CURDATE()) AS age FROM adopsi_binatang.animals WHERE name LIKE '%$search%' or type like '%$search%' or location like '%$search%' or size like '%$search%'";
