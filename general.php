...
$resultAnimals = mysqli_query($conn, "Select *, TIMESTAMPDIFF(YEAR, date_of_birth, CURDATE()) AS age from adopsi_binatang.animals WHERE date_of_birth > CURRENT_DATE - INTERVAL 96 month");
