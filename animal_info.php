    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <hr>
                <p style="text-allign: justify";> <?= $description ?> </p>

                <a id="holder" href="https://api.whatsapp.com/send/?phone=%2B6281298673656&text&type=phone_number&app_absent=0">
                    <div class="button">
                        <p class="btnText">Contact Us</p>
                        <div class="btnTwo">
                            <p class="btnText2"><i class="fa fa-whatsapp"></i></p>
                        </div>
                    </div>
                </a>
